 ...
 *
 *	Purpose: Calculate Heart Rate and SpO2 level
 *
 *	Details: By detecting  peaks of PPG cycle and corresponding AC/DC of red/infra-red signal,
 *			 the ratio for the SPO2 is computed. Since this algorithm is aiming for Arm M0/M3.
 *			 formula for SPO2 did not achieve the accuracy due to register overflow.
...
/*
 *	=======================================================
 *	Function name: maxim_find_peaks
 *
 *	Purpose: Find at most MAX_NUM peaks above MIN_HEIGHT separated by at least min distance
 *
 *	Details:
 *
 *  Parameters:
...
/*
 *	=======================================================
 *	Function name: maxim_peaks_above_min_height
 *
 *	Purpose: Find peaks above n_min_height
 *
...
/*
 *	=======================================================
 *	Function name: maxim_remove_close_peaks
 *
 *	Purpose: Remove peaks
 *
 *	Details: Removes peaks separated by less than MIN_DISTANCE. Used to
 *			 filter out noise
 *
 *  Parameters:
 *  	NAME						DESCRIPTION
...
/*
 *	=======================================================
 *	Function name: maxim_sort_ascend
 *
 *	Purpose: Sort array
 *
 *	Details: Sort array in ascending order
 *
 *  Parameters:
 *  	NAME						DESCRIPTION
 *  	None						- None
...
/*
 *	=======================================================
 *	Function name: maxim_sort_indices_descend
 *
 *	Purpose: Sort indices
 *
 *	Details: Sort indices in descending order
 *
 *  Parameters:
 *  	NAME						DESCRIPTION
 *  	None						- None
